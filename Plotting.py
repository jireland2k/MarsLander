...
if additional_plots == True:
    ...
    ax.scatter(dftPI, velPI, c='b', marker='.', alpha = 0.3)
    ...
    ax.scatter(dftPI, velPI, c='b', marker='.', alpha = 0.2)
    ...
    ax.scatter(dftPI, scorePI, c='b', marker='.', alpha = 0.2)
    ...
    ax.scatter(velPI, scorePI, c='b', marker='.', alpha = 0.2)
    ...
    ax.scatter(velPI, fuelPI, c='b', marker='.', alpha = 0.2)
    ...
    ax.scatter(dftPI, fuelPI, c='b', marker='.', alpha = 0.2)
    ...
    ax.scatter(fuelPI, scorePI, c='b', marker='.', alpha = 0.2)
