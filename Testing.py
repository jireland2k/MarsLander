...
K_hlist = list(np.linspace(0.001, 0.050, 18))
K_plist = list(np.linspace(0.000, 1.000, 16))
K_ilist = list(np.linspace(0.000, 1.000, 16))
K_dlist = list(np.linspace(0.000, 1.000, 16))
